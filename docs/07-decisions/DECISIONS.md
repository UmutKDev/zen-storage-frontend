...
- **D-P1.4 — Deferred from this pass:** passkey login → Phase 2 (needs passkey registration first); legal pages + cookie-consent banner → immediate follow-up (no analytics SDK to gate yet).
